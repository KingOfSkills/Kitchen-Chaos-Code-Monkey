...
public class GameLobby : MonoBehaviour
{
    ...
    public async void CreateLobby(string lobbyName, bool isPrivate)
    {
        ...
        try
        {
            joinedLobby = await LobbyService.Instance.CreateLobbyAsync(lobbyName, GameMultiplayer.MAX_NUMBER_PLAYERS, new CreateLobbyOptions {
                IsPrivate = isPrivate,
            });
    ...
    public async void QuickJoin()
    {
        ...
        {
            OnQuickJoinedFailed?.Invoke(this, EventArgs.Empty);
            Debug.Log(e);
        }
    }
